...
export function CryptoList({ cryptos }: CryptoListProps) {
  ...
  const [sortBy, setSortBy] = useState<keyof CoinMarketCapCoinData | "percent_change_24h" | "market_cap">("cmc_rank")
  const [sortOrder, setSortOrder] = useState<"asc" | "desc">("asc")
  const [favorites, setFavorites] = useState<Record<number, boolean>>({})

  const handleSort = (column: keyof CoinMarketCapCoinData | "percent_change_24h" | "market_cap") => {
    if (sortBy === column) {
            ...
            <Table>
              <TableHeader className="bg-gray-950">
                <TableRow>
                  ...
                  <TableHead className="hidden lg:table-cell text-right">Circulating Supply</TableHead>
                  <TableHead className="w-24 text-right">Last 7d</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
